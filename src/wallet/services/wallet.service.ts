...
export class WalletService {
    ...
    async updateWallet(wallet_id:string ,newWalletInfo: Wallet): Promise<IWallet> {
        this.wallets.find(wallet => wallet.id === wallet_id).name = newWalletInfo.name;
        this.wallets.find(wallet => wallet.id === wallet_id).address = newWalletInfo.address;
        this.wallets.find(wallet => wallet.id === wallet_id).type = newWalletInfo.type;
